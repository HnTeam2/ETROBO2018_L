...
const float ConstParam::PID_TASK_1[3] = {1.0,0.2,0.02};
const float ConstParam::PID_TASK_2[3] = {3.80, 0.8, 0.15};
const float ConstParam::PID_TASK_3[3] = {1.0, 0.01, 0.1};
const float ConstParam::PID_TASK_90[3] = {0.4, 0.02, 0.05};
...
const short ConstParam::SPEED_TASK_3 = 30;
